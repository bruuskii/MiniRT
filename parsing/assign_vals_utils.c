...
/*   Updated: 2024/12/31 17:46:37 by kbassim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_assign_sp_utils(t_sp **sp, char **lst, int i)
{
    ...
    else if (i == 2)
    {
        ...
        if (((*sp)->color->x > 255 || (*sp)->color->y > 255 || (*sp)->color->z > 255) || ((*sp)->color->x < 0 || (*sp)->color->y < 0 || (*sp)->color->z < 0))
...
void    ft_assign_light_utils(t_light **lt, char **lst, int i)
{
    ...
    else if (i == 2)
    {
        ...
        if (((*lt)->color->x > 255 || (*lt)->color->y > 255 || (*lt)->color->z > 255) || ((*lt)->color->x < 0 || (*lt)->color->y < 0 || (*lt)->color->z < 0))
...
void    ft_assign_cn_utils(t_cone **cn, char **lst, int i)
{
    ...
    else if (i == 5)
    {
        ...
        if (((*cn)->color->x > 255 || (*cn)->color->y > 255 || (*cn)->color->z > 255) || ((*cn)->color->x < 0 || (*cn)->color->y < 0 || (*cn)->color->z < 0))
